...
import { r as renderErrorPage, t as createCsrfMiddleware } from "./createCsrfMiddleware-DPSrMl-O.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-pJcWhUrF.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CkkYTxhN.mjs"),
		import("./start-BR5x7MWA.mjs"),
...
var serverEntry = createServerEntry({ fetch });
